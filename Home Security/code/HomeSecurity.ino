...
const char* password = "vasu8278
";

String chatId = "1695162178";

String BOTtoken = "7866687631:AAGgLEoZgfQTAxfAzZaZRepVDM7g29yaOCg";
...
// ISR Indicates when motion is detected
...
void handleNewMessages(int numNewMessages){
  ...
  for (int i = 0; i < numNewMessages; i++){
    ...
    if (text == "/start"){
      ...
      welcome += "Use the following command to Setup th
